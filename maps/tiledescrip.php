...
{
echo "You are in the northwest corner of your father's cellar. There is a large barrel in the floor, and walls block the way west and north.";
}
...
{
echo "You are in the southwest corner of your father's barn. There is an old woodpile here. Walls block your way west and south.";
}

if ($row['map']=="barn" and $row['xaxis']==2 and $row['yaxis']==1)
{
echo "You are in the south end of your father's barn. The barn door leading out to the yard is located here on the south wall.";
}

if ($row['map']=="barn" and $row['xaxis']==3 and $row['yaxis']==1)
{
echo "You are in the southeast corner of your father's barn. There is a trapdoor in the floor here. Walls block your way east and south.";
}

if ($row['map']=="barn" and $row['xaxis']==1 and $row['yaxis']==2)
{
echo "You are at the western end of your father's barn. There is a bale of hay here. A wall blocks your way west.";
}

if ($row['map']=="barn" and $row['xaxis']==2 and $row['yaxis']==2)
{
echo "You are in the center of your father's barn.";
}

if ($row['map']=="barn" and $row['xaxis']==3 and $row['yaxis']==2)
{
echo "You are at the eastern end of your father's barn. There is a canvas bag here. A wall blocks your way east.";
}

if ($row['map']=="barn" and $row['xaxis']==1 and $row['yaxis']==3)
{
echo "You are in the northwest corner of your father's barn. There is a cheese making area here. A wall blocks your way to the west and north.";
}

if ($row['map']=="barn" and $row['xaxis']==2 and $row['yaxis']==3)
{
echo "You are in the northern end of your father's barn. The old milk cow stands here waiting to be milked. A wall blocks the way north.";
}
if ($row['map']=="barn" and $row['xaxis']==3 and $row['yaxis']==3)
{
echo "You are in the northeast corner of your father's barn. There are some water troughs here, and walls block your way north and east.";
}
}
