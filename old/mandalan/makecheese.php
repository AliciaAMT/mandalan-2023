...
if ($milk>2)
{
echo "<table class=\"page\"><tr><td class=\"page\"><h3>You made one cheese.</h3><table class=\"page\"><tr><td class=\"page\"><form action=\"makecheese.php?";
...
{
echo "<table class=\"page\"><tr><td class=\"page\"><h3>You do not have enough milk.</h3><form action=\"maingraphics.php?";
