...
$query = sprintf("update enemy set enemyname='Bat' where username='%s';",mysql_real_escape_string($username));
mysql_query($query);
...
$query = sprintf("update enemy set enemyatt1dam=20 where username='%s';",mysql_real_escape_string($username));
mysql_query($query);

$query = sprintf("update enemy set enemyatt2='Small Bite' where username='%s';",mysql_real_escape_string($username));
mysql_query($query);

$query = sprintf("update enemy set enemyatt2dam=25 where username='%s';",mysql_real_escape_string($username));
mysql_query($query);
...
$query = sprintf("update enemy set enemyspeed=35 where username='%s';",mysql_real_escape_string($username));
mysql_query($query);

$query = sprintf("update enemy set enemyagility=30 where username='%s';",mysql_real_escape_string($username));
mysql_query($query);

$query = sprintf("update enemy set enemystrength=35 where username='%s';",mysql_real_escape_string($username));
mysql_query($query);
...
$query = sprintf("update enemy set enemyarmor=0 where username='%s';",mysql_real_escape_string($username));
mysql_query($query);
