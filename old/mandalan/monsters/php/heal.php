...
include ('../php/getstats.php');
  ...
  echo $water;
  echo "</td></tr><tr><td class=\"page\" width=\"375px\">Life +50<br />Mana +50</td><td class=\"page\"><table class=\"page\"><tr><td class=\"page\"><form action=\"drinkwater.php?".time()."\" method=\"post\"><input class=\"small\" type=\"submit\" value=\"Drink Water\" /></form></td></tr></table></td></tr></table>";
