...
$itemname="Bat Wings";
$itemdescription="These bat wings are common ingredients in potions.";
$itemtype="Other";
$itemimage="batwings";
$itemlevel=1;
$itemrarity="Common";
...
{
$query=sprintf("update inventory set keep=keep+1 where username='%s' and itemname='Bat Wings';", mysql_real_escape_string($username));
mysql_query ($query);
