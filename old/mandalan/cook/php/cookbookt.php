...
echo "<tr><td class=\"border\"><h3>".$row['itemname']."<br />Level ".$row['itemlevel']."</h3>".$row['itemrarity'];
...
<table class=\"page\"><tr><td class=\"page\"><form name=\"drink\" action=\"drinkt.php?".time();
...
if ($row['consumable']==1)
{
echo "<tr><td class=\"page\" colspan=\"2\"><table class=\"page\"><tr><td class=\"page\"><form name=\"cook\" action=\"consumet.php?".time()."\" method=\"get\"><input class=\"invisible\" type=\"radio\" name=\"food\" checked=\"checked\" value=\"".$row['itemname']."\"><br /><input type=\"submit\" value=\"Consume\" class=\"small\"></form></td></tr></table></td></tr>";
}
...
<table class=\"page\"><tr><td class=\"center\" colspan=\"2\"><h2>Fried Meat</h2></td></tr><tr><td class=\"left\" colspan=\"2\">This classic dish is one of the simplest recipes you know.</td></tr><tr><td class=\"center\">
...
<tr><td class=\"page\" colspan=\"2\"><table class=\"page\"><tr><td class=\"page\"><form name=\"cook\" action=\"cookt.php?".time()."\" method=\"get\"><input class=\"invisible\" type=\"radio\" name=\"food\" checked=\"checked\" value=\"friedmeat\"><br /><input type=\"submit\" value=\"Cook\" class=\"small\"></form></td></tr></table></td></tr></table>
</td></tr>";

if ($meatsandwich>0)
{
echo "<tr><td class=\"border\">
<table class=\"page\"><tr><td class=\"center\" colspan=\"2\"><h2>Fried Meat Sandwich</h2></td></tr><tr><td class=\"left\" colspan=\"2\">This classic dish is one of the simplest recipes you know, but it is more nutritous than meat or bread alone.</td></tr><tr><td class=\"center\">
...
<tr><td class=\"page\" colspan=\"2\"><table class=\"page\"><tr><td class=\"page\"><form name=\"cook\" action=\"cookt.php?".time()."\" method=\"get\"><input class=\"invisible\" type=\"radio\" name=\"food\" checked=\"checked\" value=\"meatsandwich\"><br /><input type=\"submit\" value=\"Cook\" class=\"small\"></form></td></tr></table></td></tr></table>
</td></tr>";
