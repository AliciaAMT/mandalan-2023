...
while($row = mysql_fetch_array($result))
  ...
  echo "<table class=\"page\"><tr><td class=\"center\"><h3>Water Break</h3>You drink one eight-hour serving of water and heal Life +5 and Mana +5.</td></tr><tr><td class=\"left\">Life: ".$row['life']."/".$row['maxlife']."</td></td><tr><td class=\"left\">Mana: ".$row['mana']."/".$row['maxmana']."</td></tr><tr><td class=\"center\"><table class=\"page\"><tr><td class=\"center\">";
...
echo "<form action=\"../monsters/drankt.php?";
