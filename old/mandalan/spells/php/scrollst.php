...
if ($row['offensive']==0)
{
echo "<tr><td class=\"center\"><table class=\"page\"><tr><td class=\"page\"><form action=\"castscrollt.php?";
echo time();
echo "\" method=\"post\">
...
{
echo "<tr><td class=\"center\"><form action=\"castscrollt.php?";
echo time();
...
echo "<tr><td class=\"center\"><form action=\"castspellt.php?";
...
echo "<tr><td class=\"center\" colspan=\"2\"><table class=\"page\"><tr><td class=\"page\"><form action=\"readscrollt.php?";
