...
echo "<table class=\"page\"><tr><td class=\"center\"><h2>".$spell."</h2>You set ".$spell." as your quickspell.</td></tr><tr><td class=\"center\"><table class=\"page\"><tr><td class=\"page\">";

if ($fight==1)

{

echo "<form action=\"../monsters/setspellt.php?".time()."\" method=\"post\"><input class=\"small\" type=\"submit\" value=\"Back\" /></form>";
