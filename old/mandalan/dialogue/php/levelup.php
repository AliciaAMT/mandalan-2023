...
$query=sprintf("update stats set strength=strength+2 where username='%s';", mysql_real_escape_string($username));
mysql_query($query);

$query=sprintf("update stats set agility=agility+2 where username='%s';", mysql_real_escape_string($username));
mysql_query($query);

$query=sprintf("update stats set speed=speed+2 where username='%s';", mysql_real_escape_string($username));
mysql_query($query);
