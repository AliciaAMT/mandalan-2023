...
$query=sprintf("select newcharacter from flags where username='%s';",mysql_real_escape_string($username));
...
$query=sprintf("update flags set newcharacter=1 where username='%s';",mysql_real_escape_string($username));
mysql_query($query);
...
<table class=\"page\"><tr><td class=\"page\"><form action=\"maingraphics.php?".time()."\" method=\"post\"><input class=\"small\" type=\"submit\" value=\"Continue\" /></form></td></tr></table></td></tr></table></body></html>");
	...
	$query=sprintf("update flags set newcharacter=2 where username='%s';",mysql_real_escape_string($username));
mysql_query($query);
	...
	$query=sprintf("update flags set newcharacter=3 where username='%s';",mysql_real_escape_string($username));
mysql_query($query);
