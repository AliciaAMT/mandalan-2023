...
while($row = mysql_fetch_array($result))
  ...
  {
  echo "<h4><a href=\"objectt.php?".time();
  echo "\">Rug</a></h4>";
  }
  
if ($row['map']=="homeup" and $row['xaxis']==2 and $row['yaxis']==1)
  {
  echo "<h4><a href=\"gwatert.php?".time();
  echo "\">Water Barrel</a></h4>";
  }
...
if ($row['map']=="homeup" and $row['xaxis']==1 and $row['yaxis']==3)
  {
  echo "</h4><a href=\"bedt.php\">Bed</a></h4>";
  }
...
if ($row['map']=="home" and $row['xaxis']==2 and $row['yaxis']==1)
  ...
  {
  echo "<h4><a href=\"fireplacet.php?".time();
  echo "\">Fireplace</a></h4>";
  }
...
if ($row['xaxis']==3 and $row['yaxis']==2)
  {
  echo "<h4><a href=\"objectt.php?".time();
  echo "\">Canvas Sack</a></h4>";
  }

if ($row['xaxis']==1 and $row['yaxis']==3)
  {
  echo "<h4><a href=\"objectt.php?".time();
  echo "\">Cheese Station</a></h4>";
  }

if ($row['xaxis']==3 and $row['yaxis']==3)
  {
  echo "<h4><a href=\"gwatert.php?".time();
  echo "\">Water Trough</a></h4>";
  }
