...
$itemname="Fried Eggs";
$itemdescription="Fried Eggs can be very nutritious alone or in a sandwich.";
$itemtype="Food";
$itemimage="friedeggs";
$itemlevel=1;
$itemrarity="Common";
...
$armorbase=0;
$accbase=0;
$enhancement1="Life +60";
$enhancement2="Mana +35";
$enhancement3="None";
$enchantment1="None";
$enchantment2="None";
$enchantment3="None";
...
{
$query=sprintf("update inventory set keep=keep+1 where username='%s' and itemname='Fried Eggs';", mysql_real_escape_string($username));
mysql_query ($query);
