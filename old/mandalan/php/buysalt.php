...
$query=sprintf("update stats set gold=gold-1 where username='%s';", mysql_real_escape_string($username));
mysql_query ($query);
}
}

echo "<img src=\"images/salt.png\"><br />You bought salt for 1 gold. <br /><table class=\"page\"><tr><td class=\"border\"><form action=\"ingredientshop.php\" method=\"post\"><input type=\"submit\" class=\"small\" value=\"Continue\" /></form></td></tr></table></body></html>";
?>