...
$itemname="Cinnamon";
$itemdescription="This is a common ingredient in potions and food recipes.";
$itemtype="Food";
$itemimage="cinnamon";
$itemlevel=1;
$itemrarity="Common";
...
$query=sprintf("update stats set gold=gold-2 where username='%s';", mysql_real_escape_string($username));
mysql_query ($query);
}
}

echo "<img src=\"images/cinnamon.png\"><br />You bought cinnamon for 2 gold. <br /><table class=\"page\"><tr><td class=\"border\"><form action=\"ingredientshop.php\" method=\"post\"><input type=\"submit\" class=\"small\" value=\"Continue\" /></form></td></tr></table></body></html>";
?>