...
$lockpicking=$lockpicking+$blockpicking+$level+$luck;
$randl=rand(1,100);
$lockpicking=$lockpicking*$randl;

if ($lockpick<1)
{
die ("<table class=\"page\"><tr><td class=\"center\">You do not have a lockpick.</td></tr></table><br /><table class=\"page\"><tr><td class=\"page\"><form action=\"objectt.php?".time()."\" method=\"post\"><input class=\"small\" type=\"submit\" value=\"Try Again\" /></form></td></tr></table></td></tr></table><table class=\"page\"><tr><td class=\"page\"><form action=\"maingraphict.php?".time()."\" method=\"post\"><input class=\"small\" type=\"submit\" value=\"Back to Map\" /></form></td></tr></table></td></tr></table></body></html>");
}
...
echo "<table class=\"page\"><tr><td class=\"center\">";
echo "You attempt to pick the lock, but your lockpick broke.";
echo "</td></tr>";

echo "<tr><td class=\"center\">";

echo "<table class=\"page\"><tr><td class=\"page\"><form action=\"objectt.php?".time()."\" method=\"post\"><input class=\"small\" type=\"submit\" value=\"Try Again\" /></form></td></tr></table></td></tr></table><table class=\"page\"><tr><td class=\"page\"><form name=\"sleep\" action=\"maingraphict.php?".time();
...

{
  ...
  echo "<table class=\"page\"><tr><td class=\"center\" colspan=\"2\"><h3>You unlock the chest...</h3></td></tr><tr><td class=\"left\"><h3>Found:</h3></td><td class=\"center\">Family Crest Amulet</td></tr><tr><td class=\"left\"><h3>Experience:</h3></td><td class=\"left\"><h3>+5</h3></td></tr><tr><td class=\"left\"><h3>Quest Updated:</h3></td><td class=\"left\"><h3>\"The Family Crest Quest\"</h3></td></tr></table><br /><table class=\"page\"><tr><td class=\"page\"><form action=\"maingraphict.php?";
