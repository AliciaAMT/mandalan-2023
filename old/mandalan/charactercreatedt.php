...
die ("You must choose a Name!<br /><form action=\"createcharactert.php\" method=\"post\"><input type=\"submit\" class=\"small\" value=\"Create Character\" /></form>");
...
if ($row['username']==$name)
	...
	die ("That name is already taken, please choose another.<br /><form action=\"createcharactert.php\" method=\"post\"><input type=\"submit\" class=\"small\" value=\"Create Character\" /></form>");
...
$querys = sprintf("insert into stats 
...
<a href="choosecharacter2.php" alt="log in">Log In</a>
