...
echo "<h2>Congratulations!</h2>You are steps away from the land of Mandala! If you have never played before, create a character. You have 6 character slots to fill. Choose Single Player mode or Single Player with Chat and press 'Play' to begin with your chosen character.<table class=\"page\"><tr><td class=\"border\"><form action=\"startgamet.php?";
echo time();
