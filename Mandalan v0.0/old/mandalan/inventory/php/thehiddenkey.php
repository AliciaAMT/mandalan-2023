...
$query=sprintf("update inventory set keep=0 where itemname='Small Rusty Key' and username='%s';", mysql_real_escape_string($username));
mysql_query($query);

$query=sprintf("update inventory set keep=0 where itemname='Locked Box' and username='%s';", mysql_real_escape_string($username));
