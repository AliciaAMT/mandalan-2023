...
{echo "<form action=\"../monsters/castt.php?";
...
echo "<form action=\"elementalst.php?";
...
echo "<table class=\"page\"><tr><td class=\"center\"><h2>".$spell."</h2>You cast ".$spell." and heal ".$life." life.</td></tr><tr><td class=\"center\">Life: ".$newlife."/".$cmaxlife."</td></tr><tr><td class=\"center\">Mana: ".$mana."/".$row['maxmana']."</td></tr><tr><td class=\"center\"><table class=\"page\"><tr><td class=\"page\">";
...
<table class=\"page\"><tr><td class=\"page\"><form action=\"../monsters/nomovet.php?".time()."\" method=\"post\"><input class=\"small\" type=\"submit\" value=\"Back\" /></form></td></tr></table>
...
$query=sprintf("update stats set enemylife=enemylife-'%s' where username='%s';", mysql_real_escape_string($damage), mysql_real_escape_string($username));
...
echo "<table class=\"page\"><tr><td class=\"center\"><h2>".$spell."</h2>You cast ".$spell." and inflict ".$damage." damage.</td></tr><tr><td class=\"center\"><table class=\"page\"><tr><td class=\"page\">";
