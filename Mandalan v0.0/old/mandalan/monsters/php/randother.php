...
$itemimage="diseasepot";
$itemname="Dreaded Disease 1";
$query=sprintf("update inventory set keep=keep+3 where username='%s' and itemname='Dreaded Disease 1';", mysql_real_escape_string($username));
mysql_query ($query);
...
$spellimage="fireball";
$spellname="Fireball";
$query=sprintf("update spellbook set learned=learned+1 where username='%s' and spellname='Fireball';", mysql_real_escape_string($username));
mysql_query ($query);

}
}

if ($rand>39 and $rand<51)

{
if (!$firstaid)
{
$itemname="First Aid Scroll";
$itemimage="redcross";
$spellname="First Aid";
$spellimage="redcross";
$spellnumber4=time();
...
$spellname="First Aid";
$spellimage="redcross";
$query=sprintf("update spellbook set learned=learned+1 where username='%s' and spellname='First Aid';", mysql_real_escape_string($username));
mysql_query ($query);
}
}
}
