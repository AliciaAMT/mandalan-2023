...
$query = sprintf("update enemy set enemy='giantbat' where username='%s';",mysql_real_escape_string($username));
mysql_query($query);
...
$query = sprintf("update enemy set enemystrength=30 where username='%s';",mysql_real_escape_string($username));
mysql_query($query);
