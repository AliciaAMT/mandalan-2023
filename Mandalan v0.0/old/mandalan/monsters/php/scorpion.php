...
$query = sprintf("update enemy set enemyatt2dam=30 where username='%s';",mysql_real_escape_string($username));
mysql_query($query);
...
$query = sprintf("update enemy set enemyagility=35 where username='%s';",mysql_real_escape_string($username));
mysql_query($query);
