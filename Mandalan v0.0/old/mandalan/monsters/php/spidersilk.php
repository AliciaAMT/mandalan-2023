...
$itemdescription="Spider silk can be used to make certain potions.";
$itemtype="Other";
$itemimage="spidersilk";
$itemlevel=1;
$itemrarity="Common";
$itemvalue=1;
$keep=3;
...
{
$query=sprintf("update inventory set keep=keep+3 where username='%s' and itemname='Spider Silk';", mysql_real_escape_string($username));
mysql_query ($query);
