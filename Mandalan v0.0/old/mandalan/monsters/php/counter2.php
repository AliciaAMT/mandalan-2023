...
//$rand=mt_rand(1,100);
//$rand=$rand*.01;
//$sbackstab=$rand*$sbackstab+$bbackstab;
...
$rand=mt_rand(1,100);
if ($breflectphys+$breflectfire+$breflectice+$breflectair+$breflectearth+$breflectlight+$breflectdark>$rand)
{
//****************************************
$counter=$counter."<span class=\"red\">";
$counter=$counter.$row['enemyname'];
...
$counter=$counter." damage and you <b>Reflect ";
