...
$counter=$counter." is dead!</span><br /><table class=\"page\"><tr><td class=\"page\"><table class=\"page\"><tr><td class=\"page\"><form action=\"loot.php?".time()."\" method=\"post\"><input class=\"small\" type=\"submit\" value=\"Loot Body\" /></form></td></tr></table>
</td></tr></table></br>";
...
$query = sprintf("update stats set life=life-25 where username='%s';",
mysql_real_escape_string($username));
mysql_query($query);
...
$query = sprintf("update stats set life=life-50 where username='%s';",
mysql_real_escape_string($username));
mysql_query($query);
...
$query = sprintf("update stats set life=life-30 where username='%s';",
mysql_real_escape_string($username));
mysql_query($query);
...
$query = sprintf("update stats set life=life-35 where username='%s';",
mysql_real_escape_string($username));
mysql_query($query);
...
$query = sprintf("update stats set life=life-40 where username='%s';",
mysql_real_escape_string($username));
mysql_query($query);
