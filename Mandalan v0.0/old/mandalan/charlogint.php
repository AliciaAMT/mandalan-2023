...
include ('php/getaccounts.php');

echo "<form action=\"startgamet.php?";
echo time();
echo "\" method=\"post\">
...
<td class=\"page\" colspan=\"2\"><h2>Choose a Character</h2></td></tr><tr><td class=\"left\">
...
<option value=\"2\">Single Player w/Chat</option>
