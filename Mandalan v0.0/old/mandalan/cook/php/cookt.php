...
<tr><td class=\"page\">
<table class=\"page\"><tr><td class=\"page\"><form name=\"keep\" action=\"cookbookt.php?".time()."\" method=\"get\"><input type=\"submit\" value=\"Back\" class=\"small\"></form></td></tr></table></td></tr></table>";
}
else
{
echo "<table class=\"page\"><tr><td class=\"page\">You do not have all of the ingredients to cook this dish.</td></tr><tr><td class=\"page\"><table class=\"page\"><tr><td class=\"page\"><form name=\"keep\" action=\"cookbookt.php?".time()."\" method=\"get\"><input type=\"submit\" value=\"Back\" class=\"small\"></form></td></tr></table></td></tr></table>";
}
}
