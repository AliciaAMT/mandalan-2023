...
$itemname="Oats";
$itemdescription="Oats is a nutritious and common ingredient in cooking.";
$itemtype="Other";
$itemimage="oats";
$itemlevel=1;
$itemrarity="Common";
...
{
$query=sprintf("update inventory set keep=keep+3 where username='%s' and itemname='Oats';", mysql_real_escape_string($username));
mysql_query ($query);
