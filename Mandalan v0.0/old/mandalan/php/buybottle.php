...
$itemname="Bottle";
$itemdescription="This bottle is good for potions or holding water.";
$itemtype="Other";
$itemimage="bottle";
$itemlevel=1;
$itemrarity="Common";
...
{
$query=sprintf("update inventory set keep=keep+1 where username='%s' and itemname='Bottle';", mysql_real_escape_string($username));
mysql_query ($query);

$query=sprintf("update inventory set maxwater=maxwater+1 where username='%s' and itemname='Bottle';", mysql_real_escape_string($username));
mysql_query ($query);
...
echo "<img src=\"images/bottle.png\"><br />You bought a bottle for 10 gold. <br /><table class=\"page\"><tr><td class=\"border\"><form action=\"ingredientshop.php\" method=\"post\"><input type=\"submit\" class=\"small\" value=\"Continue\" /></form></td></tr></table></body></html>";
?>