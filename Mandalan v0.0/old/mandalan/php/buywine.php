...
if ($row['gold']-25<0)
{
die ('Echo "You do not have enough gold. <br /> <form action=\"maingraphics.php\" method=\"post\"><input type=\"submit\" class=\"small\" value=\"Leave Inn\" /></form></body></html>');
...
$itemname="Wine";
$itemdescription="This is a common ingredient in potions and food recipes as well as being consumable by itself.";
$itemtype="Food";
$itemimage="wine";
$itemlevel=1;
$itemrarity="Common";
...
$accbase=0;
$enhancement1="Life +5";
$enhancement2="Mana +50";
$enhancement3="Accuracy -10";
$enchantment1="None";
$enchantment2="None";
$enchantment3="None";
$transmute1="None";
...
{
$query=sprintf("update inventory set keep=keep+1 where username='%s' and itemname='Wine';", mysql_real_escape_string($username));
mysql_query ($query);

}

$query=sprintf("update stats set gold=gold-50 where username='%s';", mysql_real_escape_string($username));
mysql_query ($query);
}
}

echo "<img src=\"images/wine.png\"><br />You bought wine for 50 gold. <br /><table class=\"page\"><tr><td class=\"border\"><form action=\"ingredientshop.php\" method=\"post\"><input type=\"submit\" class=\"small\" value=\"Continue\" /></form></td></tr></table></body></html>";
?>