...
$itemnumber=time();
$itemname="Book of Ancient Inscriptions";
$itemdescription="This book translates ancient inscriptions. The most interesting page contains a picture of a pyramid with the words 'Open Sesame'.";
$itemtype="Other";
$itemimage="book";
$itemlevel=1;
$itemrarity="Relic";
