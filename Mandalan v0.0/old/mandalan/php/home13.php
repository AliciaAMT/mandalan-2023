...
{
$query=sprintf("update inventory set keep=keep+2 where username='%s' and itemname='Raw Meat';", mysql_real_escape_string($username));
mysql_query ($query);
...
{
$query=sprintf("update inventory set keep=keep+6 where username='%s' and itemname='Bread';", mysql_real_escape_string($username));
mysql_query ($query);
