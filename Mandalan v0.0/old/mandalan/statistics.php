<?php include ('php/header.php'); ?><table class="page">

<tr>

<td class="page"><div class="border1">

<table class="page"><tr><td class="page" colspan="2"><img src="images/<?php include ('php/portrait.php');
...
<form action="maingraphics.php? <?php echo time(); ?>" method="post">
