...
values('%s', '%s', '%s', '%s', 'n');", mysql_real_escape_string($name),
...
echo "Comments: ";
echo $comments;
echo "<br /><br />Your signature has been submitted for approval to be posted to the guestbook. Approval should take less than 24 hours. Thank you for your visit!<br /><br /><table class=\"page\"><tr><td class=\"menu\"><a href=\"guestbook.php\">View Guestbook</a></td></tr></table><br /><br />";
mysql_close($con);
}
else
{
